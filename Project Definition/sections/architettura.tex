...
\item \textbf{Payment service}: avvia e traccia i tentativi di pagamento del checkout (scheletro architetturale, provider PayPal e carta non ancora integrati).
