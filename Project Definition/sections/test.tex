...
\item pagamento: creazione, lettura e conferma di un tentativo di pagamento, incluso il rifiuto di una doppia conferma sullo stesso pagamento;
...
\item e2e: suite per auth, CAD, cart, catalog, chatbot, notifiche, ordini e reporting (payment service non ha ancora una suite e2e: e' allo stadio di scheletro, senza provider reali da esercitare);
