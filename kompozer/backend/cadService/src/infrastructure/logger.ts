 ...
 * browser clients that can't set an Authorization header — without this, a
 * valid JWT would sit in plain text in every Grafana/Loki entry for that route.
 */
